...
DROP USER IF EXISTS 'giacomo'@'localhost';
CREATE USER 'giacomo'@'localhost' IDENTIFIED BY '654321';
DROP USER IF EXISTS 'martino'@'localhost';
CREATE USER 'martino'@'localhost' IDENTIFIED BY 'qwertyuiop';
GRANT ALL ON ecommerce.*TO'gabriele'@'localhost';
GRANT ALL ON ecommerce.*TO'giacomo'@'localhost';
GRANT ALL ON ecommerce.*TO'martino'@'localhost';
USE ecommerce;
